...
#pragma config(Motor,  port6,           left_arm_a,    tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_1)
#pragma config(Motor,  port7,           right_arm_a,   tmotorVex393_MC29, openLoop, encoderPort, I2C_2)
